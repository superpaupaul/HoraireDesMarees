...
/**
 * Classe permettant de lire des fichiers de marÃ©es avec la fonction lectureMaree ou des fichiers de hauteurs heure par heure 
 * et renvoyer des collections d'objets java marÃ©e / hauteur
 * @author superpaupaul
 *
 */
public class LectureFichierTxt {
	...
	public static CollectionMaree lectureMaree (File fichier ) {
		...
		try { BufferedReader buffer = new BufferedReader (
				...
				while ((ligneLue = buffer.readLine()) != null) {
						...
						// CrÃ©ation et ajout de la marÃ©e
						mareeDuJour.addMaree(new Maree(date,heure,minute,hauteur,coef));
						
						// parse la deuxiÃ¨me marÃ©e de la ligne (PM)
						heureTab = items[4].split(":",2);
						if(!isNumeric(heureTab[0])) { // cas oÃ¹ la marÃ©e n'existe pas
							minute = -1;
							heure = -1;
							hauteur = -1;
							coef = -1;
						...
						// parse la troisiÃ¨me marÃ©e de la ligne (BM)
						...
						// parse la quatriÃ¨me marÃ©e de la ligne (BM)
						...
						// Ajout de la marÃ©e du jour Ã  la collection
	...
	/**
	 * Renvoie true si la String en paramÃ¨tre est transformable en type numÃ©rique, et false inversement
	 * @param str
	 * @return
	 */
	...
	/**
	 * VÃ©rifie si le fichier n'a pas dÃ©jÃ  Ã©tÃ© lu, si c'est le cas on reprend la collection enregistrÃ©e, sinon on parcoure le
	 * fichier .txt et enregistre toutes les hauteursUnJour dans une CollectionHauteur, puis on Ã©cris le fichier java sur le systÃ¨me en
	 * utilisant le mÃªme nom avec un .java Ã  la fin.
	 * @param fichier
	 * @return
	 */
